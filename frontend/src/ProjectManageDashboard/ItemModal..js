          ...
          <ModalBody>
            ...
            <Form onSubmit={this.onSubmit}>
              <FormGroup>
                ...
                />
                <br />
                <Label for="Item">Client</Label>
                <Dropdown
                  isOpen={this.state.dropdownOpen}
                  toggle={this.toggledropdown}
                >
                  <DropdownToggle caret>{this.state.label}</DropdownToggle>
                  <DropdownMenu>
                    <DropdownItem
                      tag="Personal"
                      onClick={this.onselect}
                    ></DropdownItem>
                    <DropdownItem tag="Work" onClick={this.onselect}>
                      Work
                    </DropdownItem>
                    <DropdownItem tag="Shopping" onClick={this.onselect}>
                      shopping
                    </DropdownItem>
                    <DropdownItem tag="Others" onClick={this.onselect}>
                      Others
                    </DropdownItem>
                  </DropdownMenu>
                </Dropdown>
